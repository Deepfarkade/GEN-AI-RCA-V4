...
import { Mic, Send, Bot, Plus, MessageSquare, LogOut, ChevronLeft, ChevronRight, Download, Home, Sun, Moon, ArrowRight } from 'lucide-react';
            ...
            >
              {isLoading && message.sender !== 'user' && !message.text && !message.table_data && !message.summary ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-gray-400">Please wait while we are fetching your answer...</p>
                </div>
              ) : (
                <>
                  {message.table_data ? (
                ...
                { message.next_question && (
                    <div className="mt-4 space-y-2">
                      ...
                      <button
                        onClick={() => handleNextQuestionClick(message.next_question!)}
                      ...
                      >
                        <span className="flex-1 truncate">{message.next_question}</span>
                        <ArrowRight 
